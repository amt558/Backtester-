...
def run(
    ...
    try:
        ...
        if optimize:
            ...
            _emit.complete("optuna", duration_s=_t.time() - _t0)
        ...
        if walkforward:
            ...
            _emit.complete("walk_forward", duration_s=_t.time() - _t0)
        ...
        if robustness:
            ...
            _emit.complete("monte_carlo", duration_s=_t.time() - _t0)
        ...
        if tearsheet:
            try:
                ...
                _emit.complete("tearsheet", duration_s=_t.time() - _t0)
